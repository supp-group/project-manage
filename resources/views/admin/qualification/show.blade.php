...
@section('page-header')
				...
				<div class="breadcrumb-header justify-content-between">
					<div class="my-auto">
						<div class="d-flex">
							<h4 class="content-title mb-0 my-auto">المؤهل العلمي</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ جميع المؤهلات العلمية</span>
						</div>
					</div>
				</div>
				<!-- breadcrumb -->
						...
						<div class="card">
							<div class="card-header pb-0">
								<div class="d-flex justify-content-between">
									<h4 class="card-title mg-b-0">جميع المؤهلات العلمية</h4>
