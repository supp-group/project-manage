...
@section('page-header')
				...
				<div class="breadcrumb-header justify-content-between">
					<div class="my-auto">
						<div class="d-flex">
							<h4 class="content-title mb-0 my-auto">الفروع</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ تعديل فرع</span>
						</div>
					</div>
				</div>
				<!-- breadcrumb -->
								...
								<form action="{{ route('branch.update', $branch->id) }}" method="post" autocomplete="off">
									...
									<div class="row">
										<div class="col">
											...
											id="inputName" name="branch" value="{{ $branch->branch }}" required>
