										...
										<tbody>
											...
											<tr>
												...
												<td>
													...
													data-target="#delete{{$occupation->id}}"><i class="las la-trash"></i></a>
													<form action="{{route('occupation.delete', $occupation->id)}}" method="POST" enctype="multipart/form-data">
															@csrf
															@method('DELETE')
														<div id="delete{{$occupation->id}}" class="modal fade delete-modal" role="dialog">
															<div class="modal-dialog modal-dialog-centered">
																<div class="modal-content">
			
																	<div class="modal-header">
																		<h6 class="modal-title">حذف المهنة: &nbsp; {{$occupation->Name}}</h6><button aria-label="Close" class="close" data-dismiss="modal"
