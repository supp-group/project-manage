...
@section('page-header')
				...
				<div class="breadcrumb-header justify-content-between">
					<div class="my-auto">
						<div class="d-flex">
							<h4 class="content-title mb-0 my-auto">الاختصاصات</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ تعديل اختصاص</span>
						</div>
					</div>
				</div>
				<!-- breadcrumb -->
...
@endif
				...
				<div class="row">
					<div class="col-lg-12 col-md-12">
						<div class="card">
							<div class="card-body">
								<form action="{{ route('specialization.update', $specialization->id) }}" method="post" autocomplete="off">
									{{ csrf_field() }}
